...
Sou estudante de **Análise e Desenvolvimento de Sistemas (ADS)**, apaixonado por tecnologia e focado em construir soluções eficientes, modernas e com boa arquitetura de código.

- 🎓 Cursando **Análise e Desenvolvimento de Sistemas**
- 💻 Foco atual em desenvolvimento de software com **C# (.NET / MAUI)**, **Python** e **JavaScript / React**
- 🚀 Constantemente construindo projetos práticos, estudando lógica, POO e arquitetura
- 📍 Brasil
...
| :--- | :--- | :--- |
| 📱 **[ManyControl](https://github.com/Alexandrecamargo0710/ManyControl)** | Gestão financeira pessoal multiplataforma (Windows e Android) com sincronização em nuvem via Google Drive. | `C#` `.NET MAUI` `Google Drive API` |
| 🐍 **[Gestão Escolar](https://github.com/Alexandrecamargo0710/Gest-o-Escolar)** | Sistema de gestão de alunos e notas com persistência em JSON e controle completo de dados. | `Python` `JSON` |
| 🍔 **[iFome / Catálogo](https://github.com/Alexandrecamargo0710/catalogo)** | Aplicação inspirada no iFood desenvolvida com foco em interfaces dinâmicas e integração com API. | `JavaScript` `React` `WebAPI` |
...
<div align="center" style="margin-top: 10px;">
  <img height="165em" src="https://streak-stats.demolab.com?user=Alexandrecamargo0710&theme=tokyonight&hide_border=true&stroke=00D2FF" />
</div>
...
<div align="center">
  <a href="https://www.linkedin.com/in/alexandre-camargo-50b55523a/" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" />
  </a>
  <a href="mailto:alexandre@exemplo.com">
